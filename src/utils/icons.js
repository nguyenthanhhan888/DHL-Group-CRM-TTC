...
const ICONS = {
  ...
  search: _icon(`${_circle(10.5, 10.5, 6.5)}${_path('m15.5 15.5 4.5 4.5')}`),
  ...
  'chevron-left': _icon(_path('m15 6-6 6 6 6')),
  'chevron-right': _icon(_path('m9 6 6 6-6 6')),
  ...
  view: _icon(`${_path('M3.5 12s3.2-5.5 8.5-5.5 8.5 5.5 8.5 5.5-3.2 5.5-8.5 5.5S3.5 12 3.5 12Z')}${_circle(12, 12, 2.5)}`),
  edit: _icon(`${_path('m5 16.5-.8 3.3 3.3-.8L18.8 7.7l-2.5-2.5L5 16.5Z')}${_path('m14.8 6.7 2.5 2.5')}`),
  trash: _icon(`${_path('M5 7h14M9 7V4.8h6V7M7 7l.8 13h8.4L17 7M10 11v5M14 11v5')}`),
  lock: _icon(`${_rect(6, 10, 12, 10, 2)}${_path('M8.5 10V7.5a3.5 3.5 0 0 1 7 0V10M12 14v2.5')}`),
  pause: _icon(`${_circle(12, 12, 9)}${_path('M9.5 8.5v7M14.5 8.5v7')}`),
